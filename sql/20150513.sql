...
INSERT INTO `bs_about` (`id`, `out_content`, `out_add_time`, `out_save_time`, `out_people`, `out_last_release`, `about_id`, `belong`) VALUES
(1, 'tetaas', 0, 0, 'admin', 0, 0, 0),
(2, 'tetaas', 0, 0, 'admin', 0, 0, 0);
...
CREATE TABLE IF NOT EXISTS `bs_basic` (
  ...
  `sic_company` varchar(50) NOT NULL,
...
INSERT INTO `bs_basic` (`id`, `sic_title`, `sic_company`, `sic_logo`, `sic_keyword`, `sic_description`, `sic_phone`, `sic_addres`, `sic_email`, `sic_friends`, `sic_bottom`, `sic_last_release`, `belong`) VALUES
...
CREATE TABLE IF NOT EXISTS `bs_modular` (
  ...
  `mod_sort` int(11) NOT NULL DEFAULT '1',
  `s_belong` int(4) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
