<form class="form-horizontal J_ajaxForm" action="/ThinkCMFX/index.php?g=Admin&amp;m=Rbac&amp;a=roleadd_post" method="post" id="myform">
  <div class="table_full">
      <table cellpadding="2" cellspacing="2" width="100%">
        <tbody><tr>
          <th width="180">角色名称</th>
          <td><input name="name" value="" class="input" id="rolename" type="text"><span class="must_red">*</span></td>
        </tr>
        <tr>
          <th>角色描述</th>
