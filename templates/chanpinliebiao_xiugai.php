<?php include("chanpinzhongxin_nav.php") ?>
 ...
 <script type="text/javascript" charset="utf-8">
  ...
  <div class="form-actions">
        ...
        <a class="btn" id="chanpinliebiao_fanhui">返回</a>
  </div>
 <textarea style="display: none;" id="ueditor_textarea_post[post_content]" name="post[post_content]"></textarea></form>
         <script src="assets/js/jquery-1.11.1.min.js"></script>
<script type="text/javascript">
$(document).ready(function(){
  //所有留言
  $("#chanpinliebiao_fanhui").click(function(){
